...
我们设计的 CPU 采用顺序双发射九级流水，实现了 龙芯架构 32 位精简版参考手册所要求的67 条指令、26 种 CSR 寄存器、16 种例外[^0]。
...
预赛提交的作品的目录格式如下（submission/LoongArch_USTC_1_liuruibo）：
...
![IK3[2~R9HR4]DF2F@N3HVHW](C:\Users\sure\AppData\Roaming\Tencent\QQ\Temp\IK3[2~R9HR4]DF2F@N3HVHW.jpg)

性能测试结果示例

![QQ图片20230805220528](C:\Users\sure\OneDrive - USTC\桌面\QQ图片20230805220528.jpg)
